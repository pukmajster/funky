...
<div class="max-w-[800px] w-full max-h-screen overflow-y-auto p-5 mx-auto">
  ...
  <Stepper on:complete={finishSetup}>
    <Step>
      ...
      <p>
        Thanks for installing Funky! It's still in early development, so bugs are very like to
    ...
    <Step locked={lockStep}>
      ...
      <p>
        Funky needs the directory of all your games to build a list of installed mods. This list is
        refreshed everytime you launch Funky, but you can also manually trigger the refresh from
        settings, if you've since installed new mods you're still not seeing in Funky.
      </p>
